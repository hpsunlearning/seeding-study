...
p_dat <- p$data %>% mutate(body_site_corrected = ifelse(!is.na(Cat_control), Cat_control, body_site_corrected), mom_baby = ifelse(!is.na(Cat_control), "Blanks", mom_baby))
...
ggplot(p_dat, aes(Axis.1, Axis.2, color = body_site_corrected, shape = mom_baby)) +
    geom_point() +
...
ggplot(p_dat, aes(Axis.1, Axis.2, shape = mom_baby)) +
